...
export function expenseTable(items, { onChanged, hideProject = false, footer = null } = {}) {
  ...
  const rows = items.map((e) => {
    ...
    return h('tr', { class: 'clickable', onclick: () => openExpenseModal({ expense: e, onSaved: onChanged }) },
  ...
  return h('table', { class: 'table' },
    h('thead', {}, h('tr', {}, h('th', {}, 'Date'), h('th', {}, 'Expense'), h('th', {}, 'Category'), hideProject ? null : h('th', {}, 'Project'), h('th', {}, 'Paid by'), h('th', {}, 'Status'), h('th', { class: 'num' }, 'Amount'))),
    h('tbody', {}, rows),
    footer ? h('tfoot', {}, h('tr', {}, h('td', { colspan: hideProject ? 5 : 6 }, `${number(footer.total)} expense${footer.total === 1 ? '' : 's'}`), h('td', { class: 'num' }, money(footer.sumCents, footer.currency)))) : null);
}
